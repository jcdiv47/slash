...
// Two shapes, not three: the card grid and the grouped index. The small-tile
// grid that used to sit between them was a denser card grid wearing a different
// name, and Density now does that job properly.
const options: { value: DisplayStyle; icon: Icon.LucideIcon; labelKey: string }[] = [
  ...
  { value: "list", icon: Icon.Rows3, labelKey: "filter.display-index" },
];
